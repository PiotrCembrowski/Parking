      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-32 lg:px-8 lg:py-40">
        <div className="max-w-2xl">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl text-balance">
            Precision Parking Lot Striping That Lasts
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-white/80 max-w-xl">
            ...
            clean, durable line striping that maximizes parking space, improves
            traffic flow, and keeps your property fully compliant.
          </p>
