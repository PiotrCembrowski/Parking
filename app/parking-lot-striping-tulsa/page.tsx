...
export const metadata: Metadata = {
  title:
    "Parking Lot Striping Tulsa OK | ADA, Fire Lane & Line Striping Services",
  description:
    "Professional parking lot striping in Tulsa, OK. ADA compliant markings, fire lanes, sealcoating, and re-striping. Fast turnaround and competitive Tulsa pricing.",
};
...
const benefits = [
  {
    ...
    description:
      "All parking lot markings meet federal ADA guidelines and Tulsa municipal requirements.",
  },
  {
    icon: Clock,
    title: "Fast Turnaround",
    description:
      "Most Tulsa striping projects completed within 24–48 hours with minimal disruption.",
  },
  {
    icon: CheckCircle,
    title: "Premium Traffic Paint",
    description:
      "Durable, traffic-grade paint designed to handle Oklahoma weather conditions.",
  },
  {
    icon: DollarSign,
    title: "Competitive Tulsa Pricing",
    description:
      "Transparent pricing with free estimates for Tulsa businesses and property owners.",
  },
];
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg text-white/80 leading-relaxed">
              Professional parking lot striping services in Tulsa, Oklahoma.
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold">
                Professional Parking Lot Striping in Tulsa
              </h2>

              <p className="mt-4 text-muted-foreground">
                We provide professional parking lot striping for commercial
                properties throughout Tulsa including retail centers, office
                buildings, warehouses, and apartment complexes.
              </p>

              <p className="mt-4 text-muted-foreground">
                Our Tulsa striping services include new layouts, re-striping,
            ...
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden">
              <Image
                ...
                alt="Parking lot striping Tulsa"
                fill
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 grid lg:grid-cols-2 gap-12">
          <div>
            ...
            <p className="mt-4 text-white/70">
              Fast estimates for Tulsa businesses. Most projects completed
              within 24-48 hours.
            </p>
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <span>tulsa@precisionline.com</span>
              </div>
